...
// update self-updates the meta-auth-cli binary by cloning the latest source from GitHub,
...
const repoURL = "https://github.com/the20100/meta-auth-cli"

var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update meta-auth-cli to the latest version from GitHub",
...
func runUpdate(cmd *cobra.Command, args []string) error {
	...
	tmpDir, err := os.MkdirTemp("", "meta-auth-cli-update-*")
	if err != nil {
	...
	newBin := filepath.Join(tmpDir, "meta-auth-cli")
